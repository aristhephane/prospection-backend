 ...
 */
final class Version20250322124601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_entreprise CHANGE current_place current_place VARCHAR(255) DEFAULT NULL');
